...
#define YtResult_init_default                    {false, 0, 0, {""}}
...
#define YtResult_init_zero                       {false, 0, 0, {""}}
...
#define YtResult_msgOutput_tag                   2
...
extern const pb_field_t YtResult_fields[5];
...
#define YtMsg_size                               (5 + sizeof(union{char f0[23817]; char f1[sizeof(union{char f0[296]; char f21[FilePart_size];})]; char f2[sizeof(union{char f0[27674]; char f40[FilePart_size];})];}))
