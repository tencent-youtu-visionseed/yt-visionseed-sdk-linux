...
typedef PB_BYTES_ARRAY_T(10240) YtResult_dataV2_t;
...
#define YtResult_init_default                    {false, 0, false, 0, 0, {FaceDetectionResult_init_default}, false, {0, {0}}}
...
#define YtResult_init_zero                       {false, 0, false, 0, 0, {FaceDetectionResult_init_zero}, false, {0, {0}}}
...
#define YtMsg_size                               (5 + sizeof(union{char f0[11797]; char f1[sizeof(union{char f0[296]; char f21[FilePart_size];})]; char f2[sizeof(union{char f0[27674]; char f40[FilePart_size];})];}))
