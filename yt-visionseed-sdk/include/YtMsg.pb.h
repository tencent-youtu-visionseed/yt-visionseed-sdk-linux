...
#define _YtRpc_Function_MAX YtRpc_Function_deleteFaceName
#define _YtRpc_Function_ARRAYSIZE ((YtRpc_Function)(YtRpc_Function_deleteFaceName+1))
...
#define YtMsg_size                               (5 + sizeof(union{char f0[23908]; char f1[sizeof(union{char f0[296]; char f21[FilePart_size];})]; char f2[sizeof(union{char f0[27674]; char f40[FilePart_size];})];}))
